...
const mt = (e) => {
  ...
  yt = g("AsyncFunction"),
  wt = (e) => e && (q(e) || O(e)) && O(e.then) && O(e.catch),
  a = {
    isArray: _,
    isArrayBuffer: pe,
    isBuffer: He,
  ...
  function l(f, d, E) {
    ...
    if (f && !E && typeof f == "object") {
      if (a.endsWith(d, "{}"))
        ...
        return (
          (d = Re(d)),
          b.forEach(function (N, Le) {
            !(a.isUndefined(N) || N === null) &&
              t.append(
                i === !0 ? re([d], Le, o) : i === null ? d : d + "[]",
                h(N)
              );
          }),
          !1
    ...
    return $(f) ? !0 : (t.append(re(E, d, o), h(f)), !1);
  }
  const u = [],
    w = Object.assign(St, {
      defaultVisitor: l,
...
const Te = {
  ...
  Rt = typeof URLSearchParams < "u" ? URLSearchParams : Z,
  At = typeof FormData < "u" ? FormData : null,
  gt = typeof Blob < "u" ? Blob : null,
  Tt = {
    isBrowser: !0,
    classes: {
      URLSearchParams: Rt,
  ...
  Nt = ((e) => Ne && ["ReactNative", "NativeScript", "NS"].indexOf(e) < 0)(
  ...
  $t =
    ...
    function (e) {
      return new Promise(function (n, r) {
        ...
        const w = Ce(e.baseURL, e.url);
        u.open(e.method.toUpperCase(), ge(w, e.params, e.paramsSerializer), !0),
          (u.timeout = e.timeout);
        function S() {
          if (!u) return;
          const d = R.from(
        ...
        if (
          ...
          A.hasStandardBrowserEnv &&
            (c && a.isFunction(c) && (c = c(e)), c || (c !== !1 && Jt(w))))
        ) {
          const d =
  ...
  _e = {
    getAdapter: (e) => {
      ...
      for (let o = 0; o < t; o++) {
        ...
        if (
          ((r = n),
          !Xt(n) && ((r = X[(i = String(n)).toLowerCase()]), r === void 0))
        )
...
` + o)
  ...
  _request(t, n) {
    ...
    for (u = 0, w = h.length; u < w; ) l = l.then(h[u++], h[u++]);
    return l;
  }
  getUri(t) {
    t = C(this.defaults, t);
...
y.default = y;
const Be = y.create();
Be.interceptors.request.use(
  (e) => (
    e.headers.has("X-Access-Token") ||
      (e.headers = e.headers.concat(
        je().type !== "guest"
          ? {
...
Be.interceptors.response.use(
  ...
  (e) => {
    if (
      ...
      (e.response.data.code === "TOKEN_OUTDATED" ||
        e.response.data.code === "TOKEN_VERIFICATION_FAILED") &&
      typeof window < "u"
    ) {
      ...
      window.localStorage.removeItem("access_token"),
        ...
        alert("Authentification expired. Please log in again.");
    }
    throw e;
  }
);
export { je as g, Be as h };
